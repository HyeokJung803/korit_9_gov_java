...
public class ComplexSalaryCalculator {
    public static void main(String[] args) {
        ...
        double workRate = workYears < 3 ?  0.0 : workYears < 7 ?  0.05 :
        ...
        // 연차수당 계산 (기본급 기준 %)
        int yearAllowance = (int) (baseSalary * workRate);
        // 야근수당 계산
        boolean isOvertime = overtimeHours - 0 > 0;
        ...
        System.out.printf("야근수당: " + String.format("%,d", overtimePayment) + "원" + " (기본 %d시간" +
