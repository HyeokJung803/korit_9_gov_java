...
public class BuilderMain {
    public static void main(String[] args) {
        BuilderStudy buliderStudy = new BuilderStudy("김준일", 32);
        BuilderStudy buliderStudy1 = BuilderStudy.builder()
                .value1("김준일")
                .value2(32)
                .build();
        ...
        ComputerBuilder computerBuilder2 = Computer.builder().cpu("15").ram(16);
        Computer computer2 = computerBuilder2.build();

        Computer computer3 = Computer.builder().cpu("15").ram(16).build();
